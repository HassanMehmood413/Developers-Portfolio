                    ...
                    <div className="onecolumn">
                        <div className="knowme">
                            ...
                            <p className='p1 hidden'>
                                Hello! I'm a Hassan
                                <strong className='hidden'>  full-stack software engineer </strong>
                                from Lahore, PK.
                                {/* <strong className='hidden'> Projects </strong>section */}
                            </p>

                            <p className='p2 hidden'>
                                <p> As a Software Engineer, I have a multifaceted skill set, specializing in the development of Generative AI solutions (using Python, LLMs, Vectara, and RAG), as well as web (FrontEnd Development). In addition, I have experience as a Tech Trainer, where I guided students at <span>ICodeGuru</span>.I possess a varied background, having contributed to team projects in a professional capacity, competed in global hackathons @<a className='lablab' href="https://lablab.ai/u/@hassan_mehmood517" target='_blank'> Lablab.ai </a>
                                    . </p>

                                As a tech trainer at <a className='lablab'target='_blank'> ICodeGuru </a>  I've taught DSA to aspiring students by simplifying complex programming concepts (wanna see how I provide training to my students? <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vTIfocJUVuGFBAoDRGEqgNOQD16chYRfjbEXQO9tDJknQx-OYUFfKPtnPKND8mVJZplTbiGFF88LDtW/pubhtml">Click Here</a> to see my sessions).
                                <p>I have participated in multiple AI International Hackathons.</p>
                            </p>
                        </div>
